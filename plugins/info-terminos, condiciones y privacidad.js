...
let Terminos = `*_Toda la informacion que se mencione aqui no excluye a la Propietaria del Bot, y Propietarios Acredores al uso de Ɲ4MЄƇƖƬ4_ƁƇ_*
...
_- Al hacer uso de ciertos comandos que tengan como objetivo socavar la incomodidad, intranquilidad, molestia u otro termino tajante, se tomarian las respectivas sanciones o llamados de alerta para prevalecer la integridad de los/las Usuarios(as) y funcionamiento de Ɲ4MЄƇƖƬ4_ƁƇ._
...
*~ Muchas Gracias Por tomarte el tiempo en informate sobre Ɲ4MЄƇƖƬ4_ƁƇ*` 
await conn.sendFile(m.chat, pp, 'gata.mp4', Terminos)
/*.trim()
conn.sendHydrated(m.chat, Terminos,  `${wm}\nEstamos de acuerdo en Hacer Colaboraciones con Personas Comprometidas, manteniendo el Respeto Puedes Contactar si ese es el caso a esta Cuenta Oficial | https://www.instagram.com/n4mecit4_bc`, pp, 'https://github.com/n4mecit4-CB/MIKU', '饾檪饾櫀饾櫓饾櫀饾樈饾櫎饾櫓-饾檲饾樋', null, null, [
